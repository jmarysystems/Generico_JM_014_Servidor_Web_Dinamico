...
import servidor_web_dinamico_menu_e_submenu.Servidor_Web_Dinamico_Menu_01;
...
import servidor_web_dinamico_menu_e_submenu.Servidor_Web_Dinamico_Submenu_01;
 
/** 
 *
 * @author NewUser
 */
public class Servidor_Web_Dinamico_00_Main extends JApplet {
    ...
    public void init() {
        ...
        Home.adicionar_Menu(new Servidor_Web_Dinamico_Menu_01( Home ).Barra_Menu );
        Home.adicionar_SubMenu(new Servidor_Web_Dinamico_Submenu_01( Home ) );
    ...
    public static void main(String[] args) {
        ...
        JApplet applet = new Servidor_Web_Dinamico_00_Main();
        applet.init();
